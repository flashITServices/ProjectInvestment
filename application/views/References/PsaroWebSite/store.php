...
<html lang="en">
	...
	<body>
		<?php
			//if(isset($articles)) var_dump($articles); die();
		?>
					...
					<div id="aside" class="col-md-3">
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								<?php if(isset($rayons)) foreach($rayons->result() as $rayon):?>
									<div class="input-checkbox">
										<input type="checkbox" <?php if($rayon->idRayon ==1) echo "checked"?>  id="<?='category-'.$rayon->idRayon?>" class="rayon">
										<label for="<?='category-'.$rayon->idRayon?>">
											<span></span>
											<?=$rayon->designations;?>
											<small><?=$this->db->where(array("Rayon_idRayon"=>$rayon->idRayon))->from('Article')->count_all_results();?></small>
										</label>
									</div>
								<?php endforeach;?>	
						...
						<div class="aside">
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="<?= base_url('assets/') ?>vendors/img/produits-industriels.webp" alt="">
								</div>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="<?= base_url('assets/') ?>vendors/img/gumes-frais-march-agricole.webp" alt="">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="<?= base_url('assets/') ?>vendors/img/légumes-frais-marché-agricole.webp" alt="">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="<?= base_url('assets/') ?>vendors/img/noël.webp" alt="">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
						...
						<div class="row">
							...
							<?php if(isset($articles)) foreach($articles as $article) :?>
									...
									<div class="col-md-4 col-xs-6">
										<div class="product">
											<div class="product-img">
												<img style="width: 225px;height:230px" src="<?= base_url($article->getImageArticle()) ?>" alt="">
		...
		<script>
			(function($){
				const choix=document.querySelectorAll('.rayon')
				var count=0;
					choix.forEach(choix=>{
						choix.addEventListener('click',(e)=>{
							...
							if(e.currentTarget.checked){
								...
								$.ajax({
									type: "POST",
									url: "<?=base_url('article/getArticleRayon/')?>"+id,
								 ...
								 $('#productChild:last').empty().append("les articles")
														
							}
						
					},{useCapture:true,once:false});
