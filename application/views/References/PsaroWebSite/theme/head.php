		...
		<title>Hyper Psaro ECommerce</title>
		...
		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="<?= base_url('assets/') ?>vendors/css/menu.css"/>
		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet" href="<?= base_url('assets/') ?>vendors/css/style.css"/>
		<link type="text/css" rel="stylesheet" href="<?= base_url('assets/') ?>vendors/css/tabs.css"/>
        <script async src="<?= base_url('assets/') ?>vendors/js/app.js"></script>
