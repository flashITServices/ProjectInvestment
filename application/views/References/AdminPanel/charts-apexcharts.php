...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url('assets/') ?>vendorsAdmin/img/favicon.png" rel="icon">
    <link href="<?= base_url('assets/') ?>vendorsAdmin/img/apple-touch-icon.png" rel="apple-touch-icon">
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                function generateData(baseval, count, yrange) {
                                    ...
                                    while (i < count) {
                                        ...
                                        var y = Math.floor(Math.random() * (yrange.max - yrange.min + 1)) +
                                            yrange.min;
                                ...
                                new ApexCharts(document.querySelector("#bubbleChart"), {
                                    series: [{
                                            name: 'Bubble1',
                                            data: generateData(new Date('11 Feb 2017 GMT')
                                            .getTime(), 20, {
                                                    min: 10,
                                                    max: 60
                                                })
