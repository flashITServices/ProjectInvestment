        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Statistiques Paiements</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Quantite Articles par Rayons</h5>
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                new ApexCharts(document.querySelector("#pieChart"), {
                                    series: <?php echo json_encode($quantites) ?>,
                                    chart: {
                                        height: 350,
                                        type: 'pie',
                                        toolbar: {
                                    ...
                                    labels: <?php echo json_encode($etageres) ?>
                                }).render();
                            });
                            </script>
                            <!-- End Pie Chart -->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Analyse Commerciale</h5>
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                new ApexCharts(document.querySelector("#columnChart"), {
                                    series: [{
                                        name: 'Net Profit',
                                        data: <?php echo json_encode($ProfitNet) ?>
                                    }, {
                                        name: 'Revenue',
                                        data: <?php echo json_encode($prices) ?>
                                    }, {
                                        name: 'Free Cash Flow',
                                        data: <?php echo json_encode($CAMV) ?>
                                    }],
                                    chart: {
                                        type: 'bar',
                                        height: 350
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Quantite Articles Vendus</h5>
                            ...
                            document.addEventListener("DOMContentLoaded", () => {
                                new ApexCharts(document.querySelector("#lineChart"), {
                                    ...
                                    xaxis: {
                                        categories: <?php echo json_encode($designations) ?>,
                                    }
                                }).render();
                            });
                            </script>
